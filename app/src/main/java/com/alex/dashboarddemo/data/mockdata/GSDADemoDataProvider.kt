...
import com.alex.dashboarddemo.presentation.common.model.GSDAPaymentCarouselCardModel
...
object GSDADemoDataProvider {
    ...
    val gsdaProductInfoCardList = listOf(
        GSDAProductInfoCardModel(
            ...
            weekPayment = "$104",
            additionalInfo = "Pago semanal con crédito",
        ),
        GSDAProductInfoCardModel(
            chipInfo = "Promociones · Envio gratis",
